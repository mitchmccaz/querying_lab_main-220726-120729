...
def problem_four(request):
  ...
  print(f"Student Count: {Student} Course Count: {Course} Instrucor Count: {Instructor}")
...
def problem_five(request):
  ...
  student = Student.objects.create(first_name='Mitch', last_name='Mccasland', year='2022', gpa=3.0)
